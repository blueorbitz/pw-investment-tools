...
Reads from scratch: `~/notes/YYYY-MM/.scratch/YYYY-MM-DD-<TICKER>/crypto-fundamentals.md`

## Output format

Write to scratch at: `~/notes/YYYY-MM/.scratch/YYYY-MM-DD-<TICKER>/crypto-valuation.md`
